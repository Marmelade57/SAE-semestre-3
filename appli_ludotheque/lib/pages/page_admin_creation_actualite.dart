...
class PageAdminCreationActualite extends StatefulWidget {
  ...
  @override
  _PageAdminCreationActualiteState createState() => _PageAdminCreationActualiteState();
}

class _PageAdminCreationActualiteState extends State<PageAdminCreationActualite> {
  var _jeu1 = "Aucun";
  var _jeu2 = "Aucun";
  var _jeu3 = "Aucun";
  var _jeu4 = "Aucun";
                            ...
                            child: DropdownButton<String>(
                              ...
                              items: [
                                DropdownMenuItem<String>(
                                  ...
                                  child: Text(_jeu1),  // Afficher uniquement la valeur sélectionnée
                                ),
                              ],
                              onChanged: (value) {
                                setState(() {
                                  _jeu1 = value ?? _jeu1;  // Mise à jour de la valeur sélectionnée
                                });
                              },
                            ),
                          ),
                            ...
                            child: DropdownButton<String>(
                              ...
                              items: [
                                DropdownMenuItem<String>(
                                  ...
                                  child: Text(_jeu2),  // Afficher uniquement la valeur sélectionnée
                                ),
                              ],
                              onChanged: (value) {
                                setState(() {
                                  _jeu2 = value ?? _jeu2;  // Mise à jour de la valeur sélectionnée
                                });
                              },
                            ),
                          ),
                            ...
                            child: DropdownButton<String>(
                              ...
                              items: [
                                DropdownMenuItem<String>(
                                  ...
                                  child: Text(_jeu3),  // Afficher uniquement la valeur sélectionnée
                                ),
                              ],
                              onChanged: (value) {
                                setState(() {
                                  _jeu3 = value ?? _jeu3;  // Mise à jour de la valeur sélectionnée
                                });
                              },
                            ),
                          ),
                            ...
                            child: DropdownButton<String>(
                              ...
                              items: [
                                DropdownMenuItem<String>(
                                  ...
                                  child: Text(_jeu4),  // Afficher uniquement la valeur sélectionnée
                                ),
                              ],
                              onChanged: (value) {
                                setState(() {
                                  _jeu4 = value ?? _jeu4;  // Mise à jour de la valeur sélectionnée
                                });
                              },
                            ),
                          ),
